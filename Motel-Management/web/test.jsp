<%-- Document : test Created on : Jun 10, 2022, 12:32:21 AM Author : Bao --%>
                    ...
                    <%@page import="sample.users.UserDTO" %>
                        <%@page contentType="text/html" pageEncoding="UTF-8" %>
                            ...
                            <body>
                                        ...
                                        <div class="navigation">
                                            <ul>
                                                ...
                                                <% UserDTO loginUser=(UserDTO) session.getAttribute("LOGIN_USER"); if
                                                    (loginUser==null || !loginUser.getRole().equals("OW")) {
                                                    ...
                                                    <li class="active">
                                                        <a
                                                            href="MainController?action=ShowRoom&ownerID=<%=loginUser.getUserId()%>">
                                                    ...
                                                    <div class="btn-group me-1 mb-1">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu"
                                                                ...
                                                                <a class="dropdown-item" href="owner-profile.html"><i
                                                                        class='bx bx-user'></i>Tài khoản</a>
                                                                <a class="dropdown-item"
                                                                    href="owner-notification.html"><i
                                                                        class='bx bx-bell'></i>Thông báo</a>
                                                                <div class="dropdown-divider"></div>
                                                                <a class="dropdown-item" href="#"><i
                                                                        class='bx bx-log-out-circle'></i>Thoát</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="page-header">
                                                    <div class="edit-home">
                                                        <button class="btn btn-primary" data-toggle="modal"
                                                            data-target="#addHome">Thêm Nhà</button>
                                                        <button class="btn btn-success" data-toggle="modal"
                                                            data-target="#editHome">Sửa Nhà</button>
                                                        <button class="btn btn-danger" data-toggle="modal"
                                                            data-target="#deleteHome">Xóa Nhà</button>
                                                    </div>
                                                </div>
                                                <section>
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <ul class="nav nav-tabs">
                                                                <!-- dung vong for o day -->
                                                                <% List<MotelDTO> listMotel = (ArrayList<MotelDTO>)
                                                                        request.getAttribute("LIST_MOTEL");
                                                                        if (listMotel != null) {
                                                                        if (listMotel.size() > 0) {
                                                            ...
                                                            <div class="tab-content">
                                                                <!-- home1 -->
                                                                <% if (listMotel !=null) { if (listMotel.size()> 0) {
                                                                    for (MotelDTO motel : listMotel) {
                                                                    %>
                                                                    <div class="tab-pane active"
                                                                        id="a<%= motel.getMotelID()%>" role="tabpanel">
                                                                        <div class="row search">
                                                                            <div class="col-sm-12 d-flex">
                                                                                <div
                                                                                    class="col-sm-6 d-flex address-home">
                                                                                    <span>Địa chỉ: </span>
                                                                        ...
                                                                        <div class="row">
                                                                            <div
                                                                                class="col-xl-3 col-lg-6 col-sm-6 my-3">
                                                                            ...
                                                                            <!-- dung vong for o day -->
                                                                            <% List<RoomDTO> listRoom = (ArrayList
                                                                                <RoomDTO>)
                                                                                    request.getAttribute("LIST_ROOM");
                                                                                    for (RoomDTO room : listRoom) {
                                                                                    if
                                                                                    (room.getMotelID().equals(motel.getMotelID()))
                                                                                    {
                                                                                    %>
                                                                                    <div
                                                                                        class="col-xl-3 col-lg-6 col-sm-6 my-3">
                                            ...
                                            <form action="#">
                                                <div class="modal-body container-fluid">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="row">
                                                                <div class="col-md-2 text-md-right"><span>Tỉnh:</span>
                                                                </div>
                                                                <div class="col-md-3">
                                                                ...
                                                                <div class="col-md-2 text-md-right"><span>Huyện: </span>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        <select name=" " class="form-control">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-2 text-md-right pb-1"><span>Địa chỉ:
                                                                    </span></div>
                                                                <div class="col-md-8">
                                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-12  ">
                                                            <div class="form-group row">
                                                                <label for="staticEmail"
                                                                    class="col-sm-4 col-form-label text-sm-right">Mã
                                                                    Phòng</label>
                                                                <div class="col-sm-6">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="nameRoom"
                                                                    class="col-sm-4 col-form-label text-sm-right">Tên
                                                                    Phòng</label>
                                                                <div class="col-sm-6">
                                                                    <input type="text" class="form-control" value="ABC"
                                                                        id="nameRoom" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label for="typeofRoom"
                                                                    class="col-sm-4 col-form-label text-sm-right">Kiểu
                                                                    Phòng</label>
                                                                <div class="col-sm-6">
                                                                    <select name="#" id="typeofRoom"
                                                                        class="form-control">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputPassword"
                                                                    class="col-sm-4 col-form-label text-sm-right">Mô
                                                                    tả</label>
                                                                <div class="col-sm-6">
                                                                    <textarea type="text"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="row form-group">
                                                                <label for="cancel"
                                                                    class="col-md-3 col-form-label text-md-right">Lý do
                                                                    xóa</label>
                                                                <select class="form-control col-md-7" name="reason"
                                                                    id="">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <textarea type="text" name=""
                                                                    placeholder="Viết lý do khác ở đây" required
                                                                    class="form-control col-md-7" rows="3"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="row form-group">
                                                                <label for="firstname"
                                                                    class="col-md-3 col-form-label text-md-right">Mã
                                                                    phòng</label>
                                                                <input type="text" name="roomID" placeholder="Nhập Mã"
                                                                    required class="form-control col-md-7">
                                                            </div>
                                                            <div class="row form-group">
                                                                <label for="firstname"
                                                                    class="col-md-3 col-form-label text-md-right">Giá</label>
                                                                <input type="text" name="price" placeholder="Giá"
                                                                    required class="form-control col-md-7">
                                                            </div>
                                                            <div class="row form-group">
                                                                <label for="firstname"
                                                                    class="col-md-3 col-form-label text-md-right">Mô
                                                                    tả</label>
                                                                <textarea type="text" placeholder="Mô tả phòng..."
                                                                    required class="form-control col-md-7"
                                                                    rows="3"></textarea>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="modal-content modal-addRoom">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-7 text-lg-left">
                                                        <div id="lightgallery" class="row">
                                                            <a href="assets/img/bgd.jpg"
                                                                data-exthumbimage="assets/img/bgd.jpg"
                                                                data-src="assets/img/bgd.jpg"
                                                                class="col-lg-4 col-md-6 mb-4">
                                                                <img src="assets/img/bgd.jpg" alt=""
                                                                    style="width:100%;">
                                                            </a>
                                                            <a href="assets/img/bgd.jpg"
                                                                data-exthumbimage="assets/img/bgd.jpg"
                                            ...
                                            <div class="modal-footer justify-content-center">
                                                <button class="btn btn-primary" type="button" data-toggle="modal"
                                                    data-target="#editRoom">Chỉnh sửa</button>
                                                <button class="btn btn-danger" type="button"
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-12 col-md-7">
                                                            <div class="form-group row">
                                                                <label for="staticEmail"
                                                                    class="col-sm-4 col-form-label">Mã Phòng</label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" readonly
                                                                        class="form-control-plaintext" id="staticEmail"
                                                                        value="001">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="nameRoom"
                                                                    class="col-sm-4 col-form-label">Tên Phòng</label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control" value="ABC"
                                                                        id="nameRoom" required>
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="typeofRoom"
                                                                    class="col-sm-4 col-form-label">Kiểu Phòng</label>
                                                                <div class="col-sm-8">
                                                                    <select name="#" id="typeofRoom"
                                                                        class="form-control">
                                                                        <option value="">Luxury</option>
                                ...
                                <script
                                    src="https://cdnjs.cloudflare.com/ajax/libs/lightgallery/2.5.0-beta.5/lightgallery.es5.min.js"></script>
                                <script
