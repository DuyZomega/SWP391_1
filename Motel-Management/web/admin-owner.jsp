                                               ...
                                               <table id="myTable" class="table table-hover table-bordered dataTable no-footer" aria-describedby="myTable_info">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" aria-label="Tên Người Thuê: activate to sort column ascending" >CMND</th>
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" aria-label="Số Dịch Vụ: activate to sort column ascending">Gmail</th>
                                                            <th class="sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" aria-label="PT Thanh Toán: activate to sort column ascending" style="width: 350.025px;">Địa chỉ</th>
                                                    ...
                                                    <c:if test="${requestScope.LIST_OW != null}">
                                                        <c:if test="${not empty requestScope.LIST_OW}">
                                                            <tbody>
                                                                <c:forEach var="o" varStatus="counter" items="${requestScope.LIST_OW}">
