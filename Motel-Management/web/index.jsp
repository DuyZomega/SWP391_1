                        ...
                        <%@page contentType="text/html" pageEncoding="UTF-8" %>
                            ...
                            <body>
                                ...
                                <%@include file="header.jsp" %>
                                            ...
                                            <div id="carouselBanner" class="carousel slide">
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active">
                                                        <img src="./assets/img/cover-1.jpg" class="d-block w-100"
                                                            alt="cover-1">
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img src="./assets/img/cover-2.jpg" class="d-block w-100"
                                                            alt="cover-2">
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img src="./assets/img/cover-3.jpg" class="d-block w-100"
                                                            alt="cover-3">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-4  d-flex my-5">
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <p>HORD đưa cho bạn những lựa chọn phù hợp về nhà trọ để bạn có
                                                            một cuộc sống vui vẻ.</p>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-4 d-flex my-5">
                                                    <div class="image">
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <p>Thông tin minh bạch, bảo mật cao cùng với những dịch vụ uy
                                                            tín đem lại trải nghiệm tốt nhất
                                                            cho bạn</p>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-4 d-flex  my-5">
                                                    ...
                                                    <div class="content">
                                                        <h4>Hỗ trợ 24/7</h4>
                                                        <p>Luôn luôn lắng nghe, luôn luôn hỗ trợ bạn về tất cả dịch vụ
                                                            tại HORD.</p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <section id="motelList" class="motel container spacing">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h3 class="heading"><i class="fa fa-newspaper"></i> TIN CHO THUÊ</h3>
                                            <a href="MainController?action=ShowAllMotel" class="view-motel-list">Xem tất
                                                cả <i class="fa fa-angle-right"></i></a>
                                        </div>
                                                ...
                                                <c:if test="${requestScope.LIST_MOTEL_HOT != null}">
                                                    <c:if test="${not empty requestScope.LIST_MOTEL_HOT}">
                                                        ...
                                                        <c:forEach var="o" varStatus="counter"
                                                            items="${requestScope.LIST_MOTEL_HOT}">
                                                            <div class="room-item ">
                                                                <a href="MainController?action=ShowMotelDetail&motelID=${o.motelID}"
                                                                    class="motel-image">
                                                                    <img class="img-fluid" src="${o.image}" alt="nt1">
                                                                </a>
                                                                <div class="motel-title my-2">
                                                                    <a href="MainController?action=ShowMotelDetail&motelID=${o.motelID}"
                                                                        class="text-decoration-none">${o.name} <span
                                                                            style="color: black">${o.rating} <span
                                                                                style="color: yellow"> <i
                                                                                    class="fa fa-star"></i></span></span>
                                                                    </a>
                                                                </div>
                                                                <div class="motel-address ">
                                                                    <p class="address truncate"><i
                                                                            class="fas fa-map-marker-alt"></i>
                                                                        ${o.address},${o.district},${o.city}</p>
                                                                </div>
                                                                <div class="d-flex justify-content-between">
                                                                    <p><i class="fa fa-star"></i> Loại:</p>
                                                                    <p> ${o.typename}</p>
                                                                </div>
                                                                <div class="d-flex justify-content-between">
                                                                ...
                                                                <div class="motel-price d-flex justify-content-between">
                                                                    <p style="font-size: 1rem"><i
                                                                            class="fas fa-money-bill-wave"></i> Chỉ từ:
                                                                        ${o.motelprice}</p>
                                                                    <button class="button--primary"><a
                                                                            class="text-decoration-none text-white"
                                                                            href="MainController?action=ShowMotelDetail&motelID=${o.motelID}">Xem
                                                                            ngay</a></button>
                                                                </div>
                                                            </div>
                                                        </c:forEach>
                                        ...
                                        <div class="row">
                                            <div class="col-6 card intro-desc">
                                                <div class="intro-title d-flex">
                                                    ...
                                                    <p class="card-text my-3">Công ty TNHH Chém Gió Xuyên Quốc Gia HORD
                                                        <span class="text-center d-block">-
                                                            HORD Gossip Inc. -</span> <span
                                                            class="d-block text-center">Thành lập
                                                            vào 05/2022</span>
                                                    </p>

                                                </div>

                                                <div class="card-text">Là HORD, chúng tôi luôn luôn lắng nghe, luôn luôn
                                                    thấu hiểu các nhu cầu không chỉ
                                                    đơn thuần là tìm kiếm một nơi dừng chân mà còn cả môi trường cũng
                                                    như dịch vụ mang lại cảm giác
                                                    thoải mái và an toàn cho các quý khách hàng!
                                                </div>
                                            </div>
                                            <div class="col-6 intro-img"
                                                style="background-image: url(assets/img/cover-1.jpg);" alt="cover-1">
                                            </div>
                                        </div>
                                    </section>
                                    <hr class="container my-0">
                                            ...
                                            <div class="team-carousel owl-carousel owl-theme">
                                                <div class="team__item">
                                                    ...
                                                    <div class="team__details">
                                                        ...
                                                        <p>Mauris tincidunt dolor eget diam dapibus vitae finibusnisl
                                                            friuisque pretiuam</p>
                                                        <div class="team__socials">
                                                            <a href="#" target="_blank"><i
                                                                    class="fab fa-facebook-f"></i></a>
                                                            <a href="https://github.com/CTPhuongThuy#"
                                                ...
                                                <div class="team__item">
                                                    ...
                                                    <div class="team__details">
                                                        ...
                                                        <div class="team__socials">
                                                            <a href="#" target="_blank"><i
                                                                    class="fab fa-facebook-f"></i></a>
                                                            <a href="https://github.com/Quanle9851" target="_blank"><i
                                                ...
                                                <div class="team__item">
                                                    ...
                                                    <div class="team__details">
                                                        ...
                                                        <div class="team__socials">
                                                            <a href="#" target="_blank"><i
                                                                    class="fab fa-facebook-f"></i></a>
                                                            <a href="https://github.com/haitn10" target="_blank"><i
                                                                    class="fab fa-github"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="team__item">
                                                    ...
                                                    <div class="team__details">
                                                        ...
                                                        <div class="team__socials">
                                                            <a href="#" target="_blank"><i
                                                                    class="fab fa-facebook-f"></i></a>
                                                            <a href="https://github.com/DuyZomega" target="_blank"><i
                                                                    class="fab fa-github"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="team__item">
                                                    ...
                                                    <div class="team__details">
                                                        ...
                                                        <div class="team__socials">
                                                            <a href="#" target="_blank"><i
                                                                    class="fab fa-facebook-f"></i></a>
                                                            <a href="https://github.com/tuan2502" target="_blank"><i
                                                                    class="fab fa-github"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <%@include file="footer.jsp" %>
                                        ...
                                        <!-- BS4 JS -->
                                        <script
                                            src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/2.11.5/umd/popper.min.js"></script>
                                        <script
