    ...
    <nav class="myNavBar navbar navbar-expand-lg navbar-dark container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.jsp#services">Dịch vụ</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="index.jsp#aboutUs">Về chúng tôi</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="index.jsp#teamMember">Đội ngũ</a>
                </li>
            </ul>
        </div>
