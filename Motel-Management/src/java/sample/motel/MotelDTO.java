...
public class MotelDTO {
 ...
 public MotelDTO(String motelID, String name, String image, String phone, String Desct, double rating,int status) {
    ...
    public MotelDTO(String motelID, String name, String image, String phone, String Desct, String address, String district, String city, double rating, String service, String typename, double motelprice, int status) {
        this.motelID = motelID;
        this.name = name;
        this.image = image;
        this.phone = phone;
